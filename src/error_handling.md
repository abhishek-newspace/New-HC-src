...
5.2. Open the Hand Controller, and check whether the pins are connected correctly, refer it's [datasheet](https://files.rfdesign.com.au/Files/documents/RFD900x DataSheet V1.2.pdf)
