...
**How to Resolve** : Ensure that the radio configurations are correct as per the [datasheet](https://files.rfdesign.com.au/Files/documents/RFD900x DataSheet V1.2.pdf).
...
1. Check transmission buffer of the Radio on Scout for issues.
2. Check pin connection issue with the Radio on Scout, which could very likely be the case.
3. In case there are absolutely no issues between communication between ATLAS and the Scout's Radio, then the issue lies within ATLAS.
