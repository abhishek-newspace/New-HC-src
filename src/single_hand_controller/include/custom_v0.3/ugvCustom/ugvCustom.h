...
#define MAVLINK_UGVCUSTOM_XML_HASH -5306998150441095373
...
#define MAVLINK_MESSAGE_CRCS {{0, 50, 9, 9, 0, 0, 0}, {2, 137, 12, 12, 0, 0, 0}, {69, 96, 11, 30, 1, 10, 0}, {76, 152, 33, 33, 3, 30, 31}, {77, 143, 3, 10, 3, 8, 9}, {111, 34, 16, 18, 3, 16, 17}, {50001, 182, 31, 31, 0, 0, 0}, {50002, 161, 38, 38, 3, 36, 37}, {50003, 78, 181, 181, 0, 0, 0}}
#endif
...
typedef enum UGV_COMP_BITMASK
{
   ...
   UGV_COMP_MOTOR_FRONT=4, /* 0x04 Motor Controller (front) | */
   UGV_COMP_MOTOR_REAR=8, /* 0x08 Motor Controller (rear) | */
   UGV_COMP_BMS=16, /* 0x10 Battery Management System (BMS) | */
   UGV_COMP_PDU=32, /* 0x20 Power Distribution Unit (PDU) | */
   UGV_COMP_INS=64, /* 0x40 Inertial Navigation System (INS) | */
   UGV_COMP_GNSS=128, /* 0x80 GNSS | */
   UGV_COMP_ULTRASONIC=256, /* 0x100 Ultrasonic sensors | */
   UGV_COMP_LIDAR=512, /* 0x200 3D Lidar | */
   UGV_COMP_DISPLAY=1024, /* 0x400 Display unit | */
   UGV_COMP_UHF_RADIO=2048, /* 0x800 UHF Radio link | */
   UGV_COMP_HAND_CTRL=4096, /* 0x1000 Hand Controller | */
   UGV_COMP_GCS=8192, /* 0x2000 Ground Control Station (GCS) | */
   UGV_COMP_BITMASK_ENUM_END=8193, /*  | */
} UGV_COMP_BITMASK;
#endif
...
typedef enum UGV_MOTOR_ERROR_BITMASK
{
   ...
   MOTOR_OVERVTEMP=2, /* 0x02 Motor Overtemperature | */
...
# define MAVLINK_MESSAGE_INFO {MAVLINK_MESSAGE_INFO_HEARTBEAT, MAVLINK_MESSAGE_INFO_SYSTEM_TIME, MAVLINK_MESSAGE_INFO_MANUAL_CONTROL, MAVLINK_MESSAGE_INFO_COMMAND_LONG, MAVLINK_MESSAGE_INFO_COMMAND_ACK, MAVLINK_MESSAGE_INFO_TIMESYNC, MAVLINK_MESSAGE_INFO_UGV_SYSTEM_INFO, MAVLINK_MESSAGE_INFO_UGV_COMPONENT_VERSION, MAVLINK_MESSAGE_INFO_UGV_SUBSYSTEM_VERSION}
# define MAVLINK_MESSAGE_NAMES {{ "COMMAND_ACK", 77 }, { "COMMAND_LONG", 76 }, { "HEARTBEAT", 0 }, { "MANUAL_CONTROL", 69 }, { "SYSTEM_TIME", 2 }, { "TIMESYNC", 111 }, { "UGV_COMPONENT_VERSION", 50002 }, { "UGV_SUBSYSTEM_VERSION", 50003 }, { "UGV_SYSTEM_INFO", 50001 }}
