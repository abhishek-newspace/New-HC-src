#line 1 "/home/nikhil/Hand Controller Project/scout-td0-HC/src/single_hand_controller/include/custom_v0.3/ugvcustom/mavlink_msg_timesync.h"
#pragma once
...
#define MAVLINK_MSG_ID_TIMESYNC_MIN_LEN 18
#define MAVLINK_MSG_ID_111_LEN 18
#define MAVLINK_MSG_ID_111_MIN_LEN 18

#define MAVLINK_MSG_ID_TIMESYNC_CRC 198
#define MAVLINK_MSG_ID_111_CRC 198
 ...
 *
 * @param tc1  Bytes: 10-17. Time synchronization payload marker segment 1 (us). HC requests send 0. COMP responses send the UGV clock timestamp.
 * @param ts1  Bytes: 18-25. Time synchronization payload marker segment 2 (us). Current timestamp of the HC or GCS, mirrored back in response.
 * @param target_system  Bytes: 26. Target routing system validation field. Mapped as 1: UGV/Compute, 2: Hand controller, 255: GCS, 0: Broadcast.
 * @param target_component  Bytes: 27. Target component identifier address block. Mapped as 191: Compute, 190: Mission Planner GCS, 1: HC, 0: Broadcast.
 ...
 *
 * @return  Bytes: 10-17. Time synchronization payload marker segment 1 (us). HC requests send 0. COMP responses send the UGV clock timestamp.
 */
 ...
 *
 * @return  Bytes: 18-25. Time synchronization payload marker segment 2 (us). Current timestamp of the HC or GCS, mirrored back in response.
 */
 ...
 *
 * @return  Bytes: 26. Target routing system validation field. Mapped as 1: UGV/Compute, 2: Hand controller, 255: GCS, 0: Broadcast.
 */
 ...
 *
 * @return  Bytes: 27. Target component identifier address block. Mapped as 191: Compute, 190: Mission Planner GCS, 1: HC, 0: Broadcast.
 */
