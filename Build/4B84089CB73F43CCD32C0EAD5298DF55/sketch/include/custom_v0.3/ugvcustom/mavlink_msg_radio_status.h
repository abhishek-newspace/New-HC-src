#line 1 "/home/nikhil/Hand Controller Project/scout-td0-HC/src/single_hand_controller/include/custom_v0.3/ugvcustom/mavlink_msg_radio_status.h"
#pragma once
 ...
 *
 * @param rxerrors  Bytes: 6-7. Total corrupted or invalid packets received by the UGV radio telemetry node since system boot up.
 * @param fixed  Bytes: 8-9. Total radio packets successfully repaired using internal forward error correction (FEC) mechanisms (Not used, set to 0-65535).
 * @param rssi  Byte: 10. Local signal strength indicator measured at the UGV receiver. Range: 0-254, 255: Invalid.
 * @param remrssi  Byte: 11. Remote endpoint link signal strength measured at hand controller. Range: 0-254, 255: Invalid.
 * @param txbuf  Byte: 12. Percentage metric tracking available transmitter buffer queue volume space (Not used, returns 0-100).
 * @param noise  Byte: 13. Local background RF electrical noise measurement envelope at the UGV unit. Range: 0-254, 255: Invalid.
 * @param remnoise  Byte: 14. Remote background RF noise recorded at the hand controller terminal unit. Range: 0-254, 255: Invalid.
...
static inline uint16_t mavlink_msg_radio_status_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint16_t rxerrors, uint16_t fixed, uint8_t rssi, uint8_t remrssi, uint8_t txbuf, uint8_t noise, uint8_t remnoise)
{
...
{
    return mavlink_msg_radio_status_pack(system_id, component_id, msg, radio_status->rxerrors, radio_status->fixed, radio_status->rssi, radio_status->remrssi, radio_status->txbuf, radio_status->noise, radio_status->remnoise);
}
...
{
    return mavlink_msg_radio_status_pack_chan(system_id, component_id, chan, msg, radio_status->rxerrors, radio_status->fixed, radio_status->rssi, radio_status->remrssi, radio_status->txbuf, radio_status->noise, radio_status->remnoise);
}
...
{
    return mavlink_msg_radio_status_pack_status(system_id, component_id, _status, msg,  radio_status->rxerrors, radio_status->fixed, radio_status->rssi, radio_status->remrssi, radio_status->txbuf, radio_status->noise, radio_status->remnoise);
}
...
static inline void mavlink_msg_radio_status_send(mavlink_channel_t chan, uint16_t rxerrors, uint16_t fixed, uint8_t rssi, uint8_t remrssi, uint8_t txbuf, uint8_t noise, uint8_t remnoise)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_RADIO_STATUS_LEN];
    _mav_put_uint16_t(buf, 0, rxerrors);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_radio_status_send(chan, radio_status->rxerrors, radio_status->fixed, radio_status->rssi, radio_status->remrssi, radio_status->txbuf, radio_status->noise, radio_status->remnoise);
#else
 ...
 */
static inline void mavlink_msg_radio_status_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint16_t rxerrors, uint16_t fixed, uint8_t rssi, uint8_t remrssi, uint8_t txbuf, uint8_t noise, uint8_t remnoise)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 *
 * @return  Bytes: 6-7. Total corrupted or invalid packets received by the UGV radio telemetry node since system boot up.
 */
 ...
 *
 * @return  Bytes: 8-9. Total radio packets successfully repaired using internal forward error correction (FEC) mechanisms (Not used, set to 0-65535).
 */
 ...
 *
 * @return  Byte: 10. Local signal strength indicator measured at the UGV receiver. Range: 0-254, 255: Invalid.
 */
 ...
 *
 * @return  Byte: 11. Remote endpoint link signal strength measured at hand controller. Range: 0-254, 255: Invalid.
 */
 ...
 *
 * @return  Byte: 12. Percentage metric tracking available transmitter buffer queue volume space (Not used, returns 0-100).
 */
 ...
 *
 * @return  Byte: 13. Local background RF electrical noise measurement envelope at the UGV unit. Range: 0-254, 255: Invalid.
 */
 ...
 *
 * @return  Byte: 14. Remote background RF noise recorded at the hand controller terminal unit. Range: 0-254, 255: Invalid.
 */
