#line 1 "/home/nikhil/Hand Controller Project/scout-td0-HC/src/single_hand_controller/arduino/hardware/avr/1.8.7/firmwares/wifishield/wifiHD/src/owl_os.c"
#include <stdlib.h>
#include <string.h>
#include <stdarg.h>
#include <stdio.h>
