#line 1 "/home/nikhil/Hand Controller Project/scout-td0-HC/src/single_hand_controller/include/custom_v0.3/ugvCustom/mavlink_msg_ugv_subsystem_version.h"
#pragma once
...
typedef struct __mavlink_ugv_subsystem_version_t {
 ...
 uint8_t component1_checksum[32]; /*<  Software checksum of component 1. The field must be zero terminated if it has a value. The field is optional and can be empty/all zeros.*/
 uint8_t component2_checksum[32]; /*<  Software checksum of component 2. The field must be zero terminated if it has a value. The field is optional and can be empty/all zeros.*/
 uint8_t component3_checksum[32]; /*<  Software checksum of component 3. The field must be zero terminated if it has a value. The field is optional and can be empty/all zeros.*/
 uint8_t component4_checksum[32]; /*<  Software checksum of component 4. The field must be zero terminated if it has a value. The field is optional and can be empty/all zeros.*/
 uint8_t component5_checksum[32]; /*<  Software checksum of component 5. The field must be zero terminated if it has a value. The field is optional and can be empty/all zeros.*/
...
#define MAVLINK_MSG_ID_UGV_SUBSYSTEM_VERSION_CRC 50
#define MAVLINK_MSG_ID_50003_CRC 50
...
#define MAVLINK_MESSAGE_INFO_UGV_SUBSYSTEM_VERSION { \
    ...
    11, \
    {  { "type", NULL, MAVLINK_TYPE_UINT8_T, 0, 20, offsetof(mavlink_ugv_subsystem_version_t, type) }, \
         { "component1_sw", NULL, MAVLINK_TYPE_UINT32_T, 0, 0, offsetof(mavlink_ugv_subsystem_version_t, component1_sw) }, \
         { "component1_checksum", NULL, MAVLINK_TYPE_UINT8_T, 32, 21, offsetof(mavlink_ugv_subsystem_version_t, component1_checksum) }, \
         { "component2_sw", NULL, MAVLINK_TYPE_UINT32_T, 0, 4, offsetof(mavlink_ugv_subsystem_version_t, component2_sw) }, \
         { "component2_checksum", NULL, MAVLINK_TYPE_UINT8_T, 32, 53, offsetof(mavlink_ugv_subsystem_version_t, component2_checksum) }, \
         { "component3_sw", NULL, MAVLINK_TYPE_UINT32_T, 0, 8, offsetof(mavlink_ugv_subsystem_version_t, component3_sw) }, \
         { "component3_checksum", NULL, MAVLINK_TYPE_UINT8_T, 32, 85, offsetof(mavlink_ugv_subsystem_version_t, component3_checksum) }, \
         { "component4_sw", NULL, MAVLINK_TYPE_UINT32_T, 0, 12, offsetof(mavlink_ugv_subsystem_version_t, component4_sw) }, \
         { "component4_checksum", NULL, MAVLINK_TYPE_UINT8_T, 32, 117, offsetof(mavlink_ugv_subsystem_version_t, component4_checksum) }, \
         { "component5_sw", NULL, MAVLINK_TYPE_UINT32_T, 0, 16, offsetof(mavlink_ugv_subsystem_version_t, component5_sw) }, \
         { "component5_checksum", NULL, MAVLINK_TYPE_UINT8_T, 32, 149, offsetof(mavlink_ugv_subsystem_version_t, component5_checksum) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_UGV_SUBSYSTEM_VERSION { \
...
static inline uint16_t mavlink_msg_ugv_subsystem_version_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint8_t type, uint32_t component1_sw, const uint8_t *component1_checksum, uint32_t component2_sw, const uint8_t *component2_checksum, uint32_t component3_sw, const uint8_t *component3_checksum, uint32_t component4_sw, const uint8_t *component4_checksum, uint32_t component5_sw, const uint8_t *component5_checksum)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_UGV_SUBSYSTEM_VERSION_LEN];
    _mav_put_uint32_t(buf, 0, component1_sw);
    _mav_put_uint32_t(buf, 4, component2_sw);
    _mav_put_uint32_t(buf, 8, component3_sw);
    _mav_put_uint32_t(buf, 12, component4_sw);
    _mav_put_uint32_t(buf, 16, component5_sw);
    _mav_put_uint8_t(buf, 20, type);
    _mav_put_uint8_t_array(buf, 21, component1_checksum, 32);
    _mav_put_uint8_t_array(buf, 53, component2_checksum, 32);
    _mav_put_uint8_t_array(buf, 85, component3_checksum, 32);
    _mav_put_uint8_t_array(buf, 117, component4_checksum, 32);
    _mav_put_uint8_t_array(buf, 149, component5_checksum, 32);
        memcpy(_MAV_PAYLOAD_NON_CONST(msg), buf, MAVLINK_MSG_ID_UGV_SUBSYSTEM_VERSION_LEN);
#else
    mavlink_ugv_subsystem_version_t packet;
    packet.component1_sw = component1_sw;
    packet.component2_sw = component2_sw;
    packet.component3_sw = component3_sw;
    packet.component4_sw = component4_sw;
    packet.component5_sw = component5_sw;
    packet.type = type;
    mav_array_memcpy(packet.component1_checksum, component1_checksum, sizeof(uint8_t)*32);
    mav_array_memcpy(packet.component2_checksum, component2_checksum, sizeof(uint8_t)*32);
    mav_array_memcpy(packet.component3_checksum, component3_checksum, sizeof(uint8_t)*32);
    mav_array_memcpy(packet.component4_checksum, component4_checksum, sizeof(uint8_t)*32);
    mav_array_memcpy(packet.component5_checksum, component5_checksum, sizeof(uint8_t)*32);
...
static inline void mavlink_msg_ugv_subsystem_version_send(mavlink_channel_t chan, uint8_t type, uint32_t component1_sw, const uint8_t *component1_checksum, uint32_t component2_sw, const uint8_t *component2_checksum, uint32_t component3_sw, const uint8_t *component3_checksum, uint32_t component4_sw, const uint8_t *component4_checksum, uint32_t component5_sw, const uint8_t *component5_checksum)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_UGV_SUBSYSTEM_VERSION_LEN];
    _mav_put_uint32_t(buf, 0, component1_sw);
 ...
 */
static inline void mavlink_msg_ugv_subsystem_version_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint8_t type, uint32_t component1_sw, const uint8_t *component1_checksum, uint32_t component2_sw, const uint8_t *component2_checksum, uint32_t component3_sw, const uint8_t *component3_checksum, uint32_t component4_sw, const uint8_t *component4_checksum, uint32_t component5_sw, const uint8_t *component5_checksum)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 */
static inline uint32_t mavlink_msg_ugv_subsystem_version_get_component1_sw(const mavlink_message_t* msg)
{
 ...
 */
static inline uint16_t mavlink_msg_ugv_subsystem_version_get_component1_checksum(const mavlink_message_t* msg, uint8_t *component1_checksum)
{
    return _MAV_RETURN_uint8_t_array(msg, component1_checksum, 32,  21);
}
 ...
 */
static inline uint32_t mavlink_msg_ugv_subsystem_version_get_component2_sw(const mavlink_message_t* msg)
{
 ...
 */
static inline uint16_t mavlink_msg_ugv_subsystem_version_get_component2_checksum(const mavlink_message_t* msg, uint8_t *component2_checksum)
{
    return _MAV_RETURN_uint8_t_array(msg, component2_checksum, 32,  53);
}
 ...
 */
static inline uint32_t mavlink_msg_ugv_subsystem_version_get_component3_sw(const mavlink_message_t* msg)
{
 ...
 */
static inline uint16_t mavlink_msg_ugv_subsystem_version_get_component3_checksum(const mavlink_message_t* msg, uint8_t *component3_checksum)
{
    return _MAV_RETURN_uint8_t_array(msg, component3_checksum, 32,  85);
}
 ...
 */
static inline uint32_t mavlink_msg_ugv_subsystem_version_get_component4_sw(const mavlink_message_t* msg)
{
 ...
 */
static inline uint16_t mavlink_msg_ugv_subsystem_version_get_component4_checksum(const mavlink_message_t* msg, uint8_t *component4_checksum)
{
    return _MAV_RETURN_uint8_t_array(msg, component4_checksum, 32,  117);
}
 ...
 */
static inline uint32_t mavlink_msg_ugv_subsystem_version_get_component5_sw(const mavlink_message_t* msg)
{
 ...
 */
static inline uint16_t mavlink_msg_ugv_subsystem_version_get_component5_checksum(const mavlink_message_t* msg, uint8_t *component5_checksum)
{
    return _MAV_RETURN_uint8_t_array(msg, component5_checksum, 32,  149);
}
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    ugv_subsystem_version->component1_sw = mavlink_msg_ugv_subsystem_version_get_component1_sw(msg);
    ugv_subsystem_version->component2_sw = mavlink_msg_ugv_subsystem_version_get_component2_sw(msg);
    ugv_subsystem_version->component3_sw = mavlink_msg_ugv_subsystem_version_get_component3_sw(msg);
    ugv_subsystem_version->component4_sw = mavlink_msg_ugv_subsystem_version_get_component4_sw(msg);
    ugv_subsystem_version->component5_sw = mavlink_msg_ugv_subsystem_version_get_component5_sw(msg);
